...
function insData() {
  ...
  else if (quantity1 == "" || (!quantity1.includes("cup") && !quantity1.includes("glass"))) {
    alert("Please enter Quantity in cup/glass");
...
function finalupdate(id){
    ...
    if (fname2 == "") {
      ...
      else if (quantity2 == "" || (!quantity2.includes("cup") && !quantity2.includes("glass"))) {
        alert("Please enter Quantity in cup/glass");
